...
public class BaseActor extends Group
{
    ...
    {
        // check if this object has moved completely off screen
        //  past any one of the four edges.
        return ( getX() + getWidth() < 0 ) || ( getX() > screenWidth ) 
             || ( getY() + getHeight() < 0 ) || ( getY() > screenHeight );
    }
